      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'average_mileage',
              isInvalid: !!formik.errors?.average_mileage,
            }}
            name="average_mileage"
            error={formik.errors?.average_mileage}
            value={formik.values?.average_mileage}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('average_mileage', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
