...
CREATE TABLE "performance" (
    ...
    "average_mileage" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "usage" ADD CONSTRAINT "usage_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
